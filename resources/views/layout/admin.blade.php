...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      {{-- Logout --}}
      <li class="nav-item">
        <a href="/logout" class="btn bg-danger" role="button">logout</a>
      </li> 
    </ul>
  </nav>
  <!-- /.navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="dashboard" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Admin Siswa</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('img/admin.jpg') }}" class="img-circle elevation-2" alt="Syauqi Parma">
        </div>
        <div class="info">
